//DOC: TextInput.jsx
// This is a reusable TextInput component built using React and Tailwind CSS.
...
// - `errorMessage`: string
// - `onChange`: function
// - `...inputProps`: Other props are passed to the textarea element

import React from 'react';
import { cn } from '../../utils/cn';

export const TextInput = (props) => {
  const { label, id, className, errorMessage, onChange, ...inputProps } = props;
