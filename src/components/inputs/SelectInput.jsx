...
// - `value`: string
// - `...props`: Other props are passed to the select element

// The `selectOpts` is an object with keys as group names and values as an array of objects with value and label keys.
